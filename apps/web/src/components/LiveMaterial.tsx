...
// The teacher's material picker is compact and out of the way — the room remembers
// the last material per lesson so it usually opens ready (#7). The student follows
// and streams answers; page navigation is driven by the room's stepper.
    ...
    <div className="live-material">
      {isTeacher && (
        <details className="live-picker">
          <summary>{lesson ? lesson.title : tr('pickMaterial')}</summary>
